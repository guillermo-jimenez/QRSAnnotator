...
for file in glob.glob(join(basedir,'*.mat')):
    _, fname = split(file)
...
# set 2 leads
leads = [figure(plot_width=1500, plot_height=80, tools=tools, x_axis_type='auto', active_drag="xbox_select") for i in range(StandardHeader.size)]
